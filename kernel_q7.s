...
main:
	...
	j setup
setup:	   
					# Setup processes   					# Unmask IRQ2,KU=1,OKU=1,IE=0,OIE=1 
	addi  $5, $0, 0x4f 		
...
scheduler: 
	...
	lw $13, pcb_timeslice($13) #this is where the timeslice of next precess is store3d
	sw $13, t_slice_temp($0) #set it to the temporray variable we will iterate
...
load_context:
	...
	movgs  $cctrl, $1    
	lw $sp, pcb_sp($13) 	
	lw $ra, pcb_ra($13) 	# Restore the other registers    
	lw	$1, pcb_reg1($13)   
	lw	$2, pcb_reg2($13)
	lw	$3, pcb_reg3($13)  
	lw	$4, pcb_reg4($13)  
